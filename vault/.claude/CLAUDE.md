...
- `singularity` — Task management (add, find, complete tasks)
...
- `mcp__singularity__*` — все Singularity операции
...
ПРАВИЛЬНЫЙ ПАТТЕРН:
1. Вызвать mcp__singularity__add-task tool
...
- `find-completed-tasks` — выполненные задачи
